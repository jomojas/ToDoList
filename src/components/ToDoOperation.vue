...
const { openEditPanel, deleteEvent, clearCompletedEvents } = todoStore
...
<template>
  <div class="flex items-center justify-center">
    <div
      class="flex justify-center items-center bg-blue-100 text-2xl w-[500px] rounded-lg shadow-lg h-20"
    >
      <button
        @click="handleOpen"
